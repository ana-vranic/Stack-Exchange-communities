...
def comparestartups_2rows(data_rep_agg, data_coreper, comm1, commr1, commr2, colors, legendtext1=["active", "closed", "st1"], legendtext2=["active", "closed", "st2"] ):
    ...
    plt.plot(data_rep_agg[commr1]["Number of active users"], ".-", color=colors["startups"], label="startups")
    plt.legend(legendtext1)
    i+=1

    plt.subplot(2,4,i)
    df.single_panel_plot(data_rep_agg, comm1, "Mean user reputation", colors, "Mean reputation")
    plt.plot(data_rep_agg[commr1]["Mean user reputation"], ".-", color=colors["startups"], label="startups")
    plt.legend().set_visible(False)
    i+=1
    ...
    plt.plot(data_coreper[commr1]["N_core"], ".-", color=colors["startups"], label="startups")
    plt.legend().set_visible(False)
    i+=1
    ...
    plt.plot(data_coreper[commr1]["Mean_dr_core"], ".-", color=colors["startups"], label="startups")
    plt.legend().set_visible(False)
    i+=1
    ...
    plt.subplot(2,4,i)
    df.single_panel_plot(data_rep_agg, comm1, "Number of active users", colors, "N active users")
    plt.plot(data_rep_agg[commr2]["Number of active users"], ".-", color=colors["startups"], label="startups")
    ...
    plt.subplot(2,4,i)
    df.single_panel_plot(data_rep_agg, comm1, "Mean user reputation", colors, "Mean reputation")
    plt.plot(data_rep_agg[commr2]["Mean user reputation"], ".-", color=colors["startups"], label="startups")
    plt.legend().set_visible(False)
    i+=1
    ...
    plt.plot(data_coreper[commr2]["N_core"], ".-", color=colors["startups"], label="startups")
    plt.legend().set_visible(False)
    i+=1
    ...
    plt.plot(data_coreper[commr2]["Mean_dr_core"], ".-", color=colors["startups"], label="startups")
    plt.legend().set_visible(False)
    i+=1
